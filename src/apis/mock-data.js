export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'BarleyDev Mern stack board',
    description: 'Pro MERN stack project',
    type: 'public', // 'private'
    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-01', 'card-id-03', 'card-id-02', 'card-id-05', 'card-id-04', 'card-id-06', 'card-id-07'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
